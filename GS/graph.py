...
class Edge(Entity):
	...
	'''
	def __init__(self, source, target, directed=False, kind="", eid=None, weight=1, label="", red=0.5, green=0.5, blue=0.5, **kwargs):
		'''
		Constructor
		'''
		self.id_num = 0
	...
	def _generate_id_num(self):
		self.id_num += 1
		return "{id_num}".format(id_num=self.id_num)
